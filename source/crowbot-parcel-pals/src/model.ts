...
export function identity(p:Program,mission:number):string{return JSON.stringify({blockSet:BLOCK_SET,mission,steps:p.steps.map(s=>s.action),tuning:p.tuning});}
